...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    masterNavigation.navigationBarHidden = YES;
...
-(NSString *) loadAppropriateXibFile : (NSString *)name
{
    ...
    if ([UIScreen mainScreen].bounds.size.height == 1024)
        ...
        xibname = [NSString stringWithFormat:@"%@P",name];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.nascenia.Dashboard" in the application's documents directory.
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Dashboard.sqlite"];
    NSError *error = nil;
